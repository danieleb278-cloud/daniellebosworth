...
caseStudies.unshift({
    ...
    snapshot: {
      ...
      toolsUsed: "Figma, Miro/Mural, Google Forms, Excel, Cacoo, Canva, Google Slides, TurboScribe (transcribing think-aloud interviews), Loom (first-click & think-aloud task interviews), ChatGPT (brainstorming), NotebookLM (organization)",
...
caseStudies.unshift({
  ...
  client: "Independent product · Academic research phase · Ongoing development",
  year: "2026",
  ...
  summary: "An independently initiated career-discovery product that became the focus of structured academic research and continues as an active, unfinished prototype exploring evidence, recommendation logic, AI interpretation, and career pathways.",
  ...
  snapshot: {
    ...
    duration: "2026–Present",
    teamSize: "Independent product ownership; collaborative research during the academic phase",
    myRole: "Product Creator, Product Designer & Prototype Developer; research contributor/lead during the academic phase",
    ...
    outcome: "Built and continue to develop an unfinished working prototype that connects evidence-based self-understanding to explainable career exploration while testing the harder system questions underneath personalization."
  },
