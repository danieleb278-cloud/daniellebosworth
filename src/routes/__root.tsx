...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Portfolio of dscript: a product strategist and UX designer crafting systems, narratives, and growth for early- and growth-stage teams." },
      { property: "og:title", content: "dscript — Product Strategy, UX & Marketing" },
      { property: "og:description", content: "Selected case studies in product strategy, UX, and marketing." },
